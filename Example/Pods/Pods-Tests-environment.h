...
// BobPullToRefresh
#define COCOAPODS_POD_AVAILABLE_BobPullToRefresh
#define COCOAPODS_VERSION_MAJOR_BobPullToRefresh 0
#define COCOAPODS_VERSION_MINOR_BobPullToRefresh 1
#define COCOAPODS_VERSION_PATCH_BobPullToRefresh 0
